...
//< 배열의 원소 내 어떤 값을 찾아내는 메소드 >
// 배열[].find((현재원소, 현재 인덱스, 전체배열)=>{반환조건}) : 콜백 함수가 반환한 조건에 맞는 원소를 찾으면 해당 원소를 반환
// 배열[].findIndex((현재원소, 현재 인덱스, 전체배열)=>{반환조건}) : 콜백 함수가 반환한 조건에 맞는 원소를 찾으면 해당 원소를 반환하고 없으면 undefined 반환